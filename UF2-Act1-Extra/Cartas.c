...
static void	fill(Carta *cards, int n)
{
	Carta	*ptr;
	int	i;
...
static void	soldier(Carta	*cards, int n)
{
	Carta	*ptr;
	int	i;
	int	cont_soldier;
...
static void	other(Carta *cards, int n)
{
	Carta	*ptr;
	int	i;
	int	aux;
...
void	free_memory(Carta *cards, int index)
{
	Carta	*ptr;
...
/*	INICIAR CARTA										*/
void	IniciarCartas(Carta *cards, int n)
{
	Carta	*ptr;
	int	i;
...
/*	MOSTRAR CARTA										*/
void	MostrarCartas(Carta *cards, int n)
{
	Carta	*ptr;
